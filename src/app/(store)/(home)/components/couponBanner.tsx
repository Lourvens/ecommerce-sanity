...
const CouponBanner = () => {
  return (
    <div className="container bg-gradient-to-r from-slate-500 to-neutral-900 text-white p-8 rounded-lg shadow-lg  mx-auto mt-3 mb-16">
      ...
      <div className="bg-white text-gray-800 rounded-lg px-4 py-2 flex items-center justify-between">
        ...
        <button className="bg-neutral-800 text-white px-3 py-1 rounded hover:bg-neutral-600 focus:outline-none focus:ring-2 focus:ring-neutral-500">
          Copy
        </button>
      </div>
